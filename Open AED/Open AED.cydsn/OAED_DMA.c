...
void OAED_DMA_Init(){
    ...
    DMA_Filter_B_Chan = DMA_Filter_B_DmaInitialize(
        DMA_Filter_B_BYTES_PER_BURST,
    ...
    CyDmaTdSetConfiguration(
        DMA_Filter_B_TD[0],
        DMA_Filter_B_BYTES_PER_BURST * ECG_DATA_SIZE,
        DMA_Filter_B_TD[0],
    ...
    DMA_Impedance_Chan = DMA_Impedance_DmaInitialize(
        DMA_Impedance_BYTES_PER_BURST,
        DMA_Impedance_REQUEST_PER_BURST,
        HI16(DMA_Impedance_SRC_BASE),
        HI16(DMA_Impedance_DST_BASE)
    );
    DMA_Impedance_TD[0] = CyDmaTdAllocate();
    CyDmaTdSetConfiguration(
        DMA_Impedance_TD[0],
        DMA_Impedance_BYTES_PER_BURST * Z_DATA_SIZE,
        DMA_Impedance_TD[0],
